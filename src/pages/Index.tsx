...
const Dashboard = () => {
  ...
  const allianzComments = useMemo(() => 
    getFilteredComments('allianz', startDate, endDate), 
    [startDate, endDate]
  );

  const prudentialComments = useMemo(() => 
    getFilteredComments('prudential', startDate, endDate), 
    [startDate, endDate]
  );
  ...
  const exportData = [
    { perusahaan: 'Allianz', ...allianzSummary, total: allianzComments.length },
    { perusahaan: 'Prudential', ...prudentialSummary, total: prudentialComments.length },
  ];
    ...
    <div className="min-h-screen bg-background">
      <div className="container py-8">
        ...
        <div className="grid gap-6">
          ...
          <SentimentBarChart 
            data={chartData} 
            title="Perbandingan Sentimen Allianz vs Prudential" 
          />
          ...
          <div className="bg-card rounded-lg p-6 border">
            ...
            <div className="space-y-3 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  {allianzSummary.positif > prudentialSummary.positif 
                    ? 'Allianz memiliki sentimen positif lebih banyak dibandingkan Prudential.'
                    : allianzSummary.positif < prudentialSummary.positif
                    ? 'Prudential memiliki sentimen positif lebih banyak dibandingkan Allianz.'
                    : 'Kedua perusahaan memiliki jumlah sentimen positif yang sama.'}
                </li>
              </ul>
            </div>
          </div>
